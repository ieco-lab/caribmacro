...
Now lets load in the species richness data and the bank attributes data. 
...
These data can also be found on Dryad at [https://doi.org/10.5061/dryad.vx0k6djtn](https://doi.org/10.5061/dryad.vx0k6djtn). If you download those data, then skip the Data Checking section and go straight to the Species Richness Analysis section after running the following code.

You can download the files manually or by using the 'rdryad' package ([https://github.com/ropensci/rdryad](https://github.com/ropensci/rdryad)).

```{r dryad data, eval = FALSE}
...
## -> green = Green_Habitat
names(bank_dat) <- c("bank", "Number", "Area", "source", "Spread", "econ_iso", "pop_avg", "DEM.sd", "anthro", "green")
